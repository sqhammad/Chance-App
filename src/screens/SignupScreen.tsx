...
import { View, StyleSheet, TextInput, Button, Text, TouchableOpacity, Image, Dimensions, Platform } from 'react-native';
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Signup')}>
        <Text style={styles.buttonText}>{isOtp ? 'Sign Up' : 'Get OTP'}</Text>
      </TouchableOpacity>
